require_relative '../max_word_frequency/module2_assignment.rb'
require 'rspec'
...
describe LineAnalyzer do
  ...
  context '#calculate_word_frequency' do
    ...
    it 'content attribute will have the correct value' do
      expect(lineAnalyzer.content).
        to eq('This is a really really really cool cool you you you')
    end
